...
export default function Card() {
  return (
    <div className="relative w-[190px] h-[254px] overflow-visible">
      <div className="w-full h-full transition-transform duration-300 transform hover:rotate-y-180 shadow-lg rounded-md group">
        {/* Back Side */}
        <div className="absolute w-full h-full bg-[#151515] rounded-md overflow-hidden backface-visibility-hidden">
          ...
          <div className="absolute inset-[0.5%] bg-[#151515] rounded-md text-white flex flex-col justify-center items-center gap-8">
            {/* <svg stroke="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" height="50" width="50" fill="#ffffff">
        ...
        {/* Front Side */}
        <div className="absolute w-full h-full bg-[#151515] rounded-md overflow-hidden backface-visibility-hidden rotate-y-180 text-white">
          <div className="absolute w-full h-full">
            {/* Floating circles */}
            <div className="floating-circle"></div>
            <div className="floating-circle-bottom"></div>
            <div className="floating-circle-right"></div>
          </div>

          <div className="absolute w-full h-full p-3 flex flex-col justify-between">
            <div className="bg-[#00000055] px-3 py-1 rounded-lg backdrop-blur-sm w-fit">
              <span className="text-xs">Pasta</span>
            </div>
            
            <div className="w-full p-3 bg-[#00000099] backdrop-blur-md rounded-md shadow-lg">
              <div className="text-center text-xs">
                <p>
                  <strong>Spaguetti Bolognese</strong>
                </p>
              </div>
              <p className="text-[#ffffff88] mt-1 text-[8px] text-center">30 Mins &nbsp; | &nbsp; 1 Serving</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        /* Neon effect - Fixed to match original exactly */
        .neon-effect {
          position: absolute;
          content: ' ';
          display: block;
