const EmailTemp = (orderData, paymentData) => {

    const { amount, contact_name, contact_number, paper_type, finishing_option, product, quantity, size, transaction_id, _id, design_image_url, address } = orderData;

    // console.log(paymentData.amount);
    
/*
paymentData.amount, paymentData.currency, paymentData.email, paymentData.name, paymentData.time, paymentData.transaction_id
*/
...
<![endif]--><!--[if !mso]><!-- -->
  <link href="https://fonts.googleapis.com/css2?family=Raleway&display=swap" rel="stylesheet"><!--<![endif]--><!--[if mso]><xml>
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="es-header-body"
                  ...
                  <tr>
                    <td align="left" class="es-m-p0b" style="padding:20px;Margin:0">
                                ...
                                <td align="left" class="es-m-txt-c"
                                  style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;font-size:0px"><a
                                    ...
                                    style="mso-line-height-rule:exactly;text-decoration:underline;color:#222222;font-size:14px"><img
                                      src="https://res.cloudinary.com/dwhcnlq8y/image/upload/v1755019812/landmarkPress_logo_sjuz25.jpg"
                                      alt="Logo" width="120" title="Logo"
                                      style="display:block;font-size:16px; border-radius:.75rem; border:0;outline:none;text-decoration:none"></a>
                                </td>
                              </tr>
                            </table>
                          </td>
...
<![endif]--><!--[if !mso]><!-- --><span class="es-button-border msohide"
                                    style="border-style:solid;border-color:#386641;background:#6A994E;border-width:1px;display:inline-block;border-radius:5px;width:auto;mso-hide:all;mso-border-alt:10px"><a
                                      href="https://viewstripo.email" target="_blank" class="es-button"
                                      style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:16px;padding:10px 30px 10px 30px;display:inline-block;background:#6A994E;border-radius:5px;font-family:Raleway, Arial, sans-serif;font-weight:normal;font-style:normal;line-height:19.2px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #6A994E">Contact</a></span><!--<![endif]-->
                                </td>
                              </tr>
                            </table>
                          </td>
...
<![endif]--><!--[if !mso]><!-- --><span class="es-button-border msohide"
                                    style="border-style:solid;border-color:#386641;background:#6A994E;border-width:1px;display:inline-block;border-radius:5px;width:auto;mso-hide:all;mso-border-alt:10px"><a
                                      ...
                                      style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:16px;padding:10px 30px 10px 30px;display:inline-block;background:#6A994E;border-radius:5px;font-family:Raleway, Arial, sans-serif;font-weight:normal;font-style:normal;line-height:19.2px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #6A994E">Support</a></span><!--<![endif]-->
                                </td>
                              </tr>
                            </table>
                          </td>
                ...
                <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" class="es-content-body"
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;position:relative"><img
                                    src="https://ewpetfe.stripocdn.email/content/guids/bannerImgGuid/images/image16788672966342121.png"
                                    alt="" title="" width="600" height="200" class="adapt-img"
                  ...
                  <tr>
                    <td align="left" bgcolor="#6a994e"
                      style="Margin:0;padding-top:30px;padding-right:20px;padding-bottom:30px;padding-left:20px;background-color:#6a994e">
                          ...
                          <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                ...
                                <h3 class="es-m-txt-c"
                                style="Margin:0;font-family:Raleway, Arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:28.8px;color:#ffffff">
                                Hello ${contact_name},</h3>
<!dynamic content--------------------------------------------------------------------------------------->                                
                                </td>
                              </tr>
                              <tr>
...
<![endif]--><!--[if !mso]><!-- --><span class="es-button-border msohide"
                                    style="border-style:solid;border-color:#ffffff;background:#ffffff;border-width:1px;display:inline-block;border-radius:5px;width:auto;mso-hide:all;mso-border-alt:10px"><a
                                      href="http://localhost:5173/dashboard/cart" target="_blank" class="es-button"
                                      style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#386641;font-size:16px;padding:10px 30px 10px 30px;display:inline-block;background:#ffffff;border-radius:5px;font-family:Raleway, Arial, sans-serif;font-weight:normal;font-style:normal;line-height:19.2px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #6A994E;border-color:#ffffff">View
                          ...
                          <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0">
                                  <h1
                                    style="Margin:0;font-family:Raleway, Arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:50px;font-style:normal;font-weight:normal;line-height:60px;color:#386641">
                                    Order summary</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" class="es-m-p10t"
                                  ...
                                  <h3 class="b_title"
                                    style="Margin:0;font-family:Raleway, Arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:28.8px;color:#386641">
                                    ORDER NO.&nbsp;${_id}</h3>
<!dynamic content--------------------------------------------------------------------------------------->
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;font-size:0px"><a target="_blank"
                                    ...
                                    style="mso-line-height-rule:exactly;text-decoration:underline;color:#6A994E;font-size:16px"><img
                                      ...
                                      alt="" width="195" class="adapt-img p_image"
                                      style="display:block;font-size:16px;border:0;outline:none;text-decoration:none;border-radius:10px"></a>
                                </td>
<!dynamic content--------------------------------------------------------------------------------------->
                              </tr>
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%"
                              ...
                              <tr>
                                <td align="left"
                                  ...
                                  <h3 class="p_name es-m-txt-c"
                                    style="Margin:0;font-family:Raleway, Arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:36px;color:#386641">
                                    ${product}</h3>
<!dynamic content--------------------------------------------------------------------------------------->
                                  <p class="p_description es-m-txt-c"
                                    ...
                                    Paper Type: ${paper_type}</p>
<!dynamic content--------------------------------------------------------------------------------------->
                                  <p class="p_description es-m-txt-c"
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:24px;letter-spacing:0;color:#4D4D4D;font-size:16px">
                                    Finishing type: ${finishing_option}</p>
<!dynamic content--------------------------------------------------------------------------------------->
                                  <p class="es-m-txt-c"
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:24px;letter-spacing:0;color:#4D4D4D;font-size:16px">
                                    SIZE: ${size}</p>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                                  ...
                                  <p
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:24px;letter-spacing:0;color:#4D4D4D;font-size:16px">
                                    ${paymentData.name}, <br>${paymentData.email}, <br>${paymentData.time}</p>
<!dynamic content--------------------------------------------------------------------------------------->
                                </td>
                              </tr>
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                                  ...
                                  <p
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:24px;letter-spacing:0;color:#4D4D4D;font-size:16px">
                                    ${contact_name}, <br>${contact_number}, <br>${address}
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                                  ...
                                  <p
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:24px;letter-spacing:0;color:#4D4D4D;font-size:16px">
                                    Transaction Id: ${paymentData.transaction_id}</p>
<!dynamic content--------------------------------------------------------------------------------------->
                                </td>
                              </tr>
                            </table>
                  ...
                  <tr>
                    <td align="left"
                      style="Margin:0;padding-top:30px;padding-right:20px;padding-left:20px;padding-bottom:40px">
                      <table cellpadding="0" cellspacing="0" width="100%" role="none"
                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                        <tr>
...
<![endif]--><!--[if !mso]><!-- --><span class="es-button-border msohide"
                                    style="border-style:solid;border-color:#386641;background:#6A994E;border-width:1px;display:inline-block;border-radius:5px;width:auto;mso-hide:all;mso-border-alt:10px"><a
                                      href="http://localhost:5173/dashboard/cart" target="_blank" class="es-button"
                                      style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:16px;padding:10px 30px 10px 30px;display:inline-block;background:#6A994E;border-radius:5px;font-family:Raleway, Arial, sans-serif;font-weight:normal;font-style:normal;line-height:19.2px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #6A994E">View
                                      Order</a></span><!--<![endif]--></td>
                              </tr>
                            </table>
                          </td>
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="es-content-body"
                  ...
                  <tr>
                    <td align="left"
                      style="Margin:0;padding-right:20px;padding-left:20px;padding-top:40px;padding-bottom:20px">
                      <table cellpadding="0" cellspacing="0" width="100%" role="none"
                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                        <tr>
                          <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                ...
                                <td align="left" style="padding:0;Margin:0">
                                  ...
                                  <p class="b_description"
                                    ...
                                    your order and it is currently being processed.<a target="_blank"
                                      style="mso-line-height-rule:exactly;text-decoration:underline;color:#6A994E;font-size:14px"
                                      href=""></a></p>
                                </td>
                              </tr>
                            </table>
                              ...
                              <tr>
                                <td align="center"
                                  ...
                                  <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                      <td
                                        style="padding:0;Margin:0;border-bottom:5px dotted #a7c957;background:unset;height:0px;width:100%;margin:0px">
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  ...
                                  <ul
                                    style="font-family:tahoma, verdana, segoe, sans-serif;padding:0px 0px 0px 40px;margin-top:15px;margin-bottom:15px">
                                    <li style="color:#4D4D4D;margin:0px 0px 15px;font-size:16px">Asia Pacific: 3 - 5
                                      business days</li>
                                    <li style="color:#4D4D4D;margin:0px 0px 15px;font-size:16px">Europe: 3 - 5 business
                                      days</li>
                                    <li style="color:#4D4D4D;margin:0px 0px 15px;font-size:16px">Latin America and the
                                      Caribbean: 3 - 5 business days</li>
                                    <li style="color:#4D4D4D;margin:0px 0px 15px;font-size:16px">North America: 3 - 5
                                      business days</li>
                                  ...
                                  <ul
                                    style="font-family:tahoma, verdana, segoe, sans-serif;padding:0px 0px 0px 40px;margin-top:15px;margin-bottom:15px">
                                    <li style="color:#4D4D4D;margin:0px 0px 15px;font-size:16px">Custom or personalized
                                      orders</li>
                                    <li style="color:#4D4D4D;margin:0px 0px 15px;font-size:16px">Perishable products
                                      (like food or flowers)</li>
                                    <li style="color:#4D4D4D;margin:0px 0px 15px;font-size:16px">Digital downloads</li>
                                    <li style="color:#4D4D4D;margin:0px 0px 15px;font-size:16px">Items on sale</li>
                                  </ul>
                                  <p
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:24px;letter-spacing:0;color:#4D4D4D;font-size:16px">
          ...
          <table cellpadding="0" cellspacing="0" align="center" class="es-footer" role="none"
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="es-footer-body"
                  role="none"
                  style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                  <tr>
                    <td align="left" style="padding:0;Margin:0">
                              ...
                              <tr>
                                <td align="center"
                                  ...
                                  <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                      <td
                                        style="padding:0;Margin:0;border-bottom:2px solid #eff7f6;background:unset;height:0px;width:100%;margin:0px">
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                          ...
                          <td align="left" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                                ...
                                <td align="center" class="es-m-txt-c"
                                  style="padding:0;Margin:0;padding-bottom:20px;font-size:0px"><a target="_blank"
                                    ...
                                    style="mso-line-height-rule:exactly;text-decoration:underline;color:#6A994E;font-size:12px"><img
                                      ...
                                      style="display:block;font-size:16px;border:0; border-radius:.75rem;outline:none;text-decoration:none"></a>
                                </td>
                              </tr>
                              <tr>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" class="es-menu"
                                    ...
                                    <tr class="links">
                                      <td align="center" valign="top" width="33.33%" id="esd-menu-id-0"
                                        ...
                                        <div style="vertical-align:middle;display:block">
                                          <a target="_blank" href=""
                                            style="mso-line-height-rule:exactly;text-decoration:none;font-family:tahoma, verdana, segoe, sans-serif;display:block;color:#6a994e;font-size:12px">Who
                                            are you</a>
                                        </div>
                                      </td>
                                      ...
                                      <td align="center" valign="top" width="33.33%" id="esd-menu-id-2"
                                        ...
                                        <div style="vertical-align:middle;display:block">
                                          <a target="_blank" href=""
                                            style="mso-line-height-rule:exactly;text-decoration:none;font-family:tahoma, verdana, segoe, sans-serif;display:block;color:#6a994e;font-size:12px">Why
                                            SAP</a>
                                        </div>
                                      </td>
                                    </tr>
                                  ...
                                  <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social"
                                    ...
                                    <tr>
                                      <td align="center" valign="top" style="padding:0;Margin:0;padding-right:20px"><a
                                          target="_blank" href="https://viewstripo.email"
                                          style="mso-line-height-rule:exactly;text-decoration:underline;color:#6A994E;font-size:12px"><img
                                            src="https://ewpetfe.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                      ...
                                      <td align="center" valign="top" style="padding:0;Margin:0;padding-right:20px"><a
                                          target="_blank" href="https://viewstripo.email"
                                          style="mso-line-height-rule:exactly;text-decoration:underline;color:#6A994E;font-size:12px"><img
                                            src="https://ewpetfe.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png"
                                      ...
                                      <td align="center" valign="top" style="padding:0;Margin:0;padding-right:20px"><a
                                          target="_blank" href="https://viewstripo.email"
                                          style="mso-line-height-rule:exactly;text-decoration:underline;color:#6A994E;font-size:12px"><img
                                            src="https://ewpetfe.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
                                      ...
                                      <td align="center" valign="top" style="padding:0;Margin:0"><a target="_blank"
                                          href="https://viewstripo.email"
                                          style="mso-line-height-rule:exactly;text-decoration:underline;color:#6A994E;font-size:12px"><img
                                            src="https://ewpetfe.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0">
                                  <p
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:19.5px;letter-spacing:0;color:#4D4D4D;font-size:13px">
                                    <a target="_blank"
                                      style="mso-line-height-rule:exactly;text-decoration:none;color:#6A994E;font-size:12px"
                                      href=""></a><a target="_blank" href="https://viewstripo.email"
                                      style="mso-line-height-rule:exactly;text-decoration:none;color:#6A994E;font-size:12px">Privacy
                                      Policy</a><a target="_blank"
                                      style="mso-line-height-rule:exactly;text-decoration:none;color:#6A994E;font-size:13px"
